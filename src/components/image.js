...
const Image=({url="https://firebasestorage.googleapis.com/v0/b/react-native-simple-chat-1e5f5.firebasestorage.app/o/face.png?alt=media"
    ,showButton, onChangePhoto
})=>{
    useEffect(()=>{
        (async ()=>{
            if (Platform.OS !== 'web'){
